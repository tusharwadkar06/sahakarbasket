...
// import watchImage from '../assets/watch.jpg'; // ✅ Ensure this path is correct relative to this file
...
//           <input type="text" placeholder="Search" style={{ padding: 8, borderRadius: 6, border: '1px solid #ccc' }} />
//           <select style={{ padding: 8, borderRadius: 6, border: '1px solid #ccc' }}>
//             <option>Category</option>
//           </select>
//           <button style={{ background: 'white', border: '1px solid #007bff', color: '#007bff', padding: '8px 12px', borderRadius: 6 }}>
//             Total Product - 2000
//           </button>
//           <button style={{ background: '#007bff', color: 'white', padding: '8px 12px', border: 'none', borderRadius: 6 }}>
//             + Add New
//           </button>
//         </div>
//       </div>
...
//         <div style={{ display: 'flex', backgroundColor: '#f0f7ff', padding: 10, fontWeight: 'bold' }}>
...
//           return (
//             <div key={index} style={{ display: 'flex', padding: 10, alignItems: 'center', borderTop: '1px solid #eee' }}>
//               <div style={{ width: '5%' }}><input type="checkbox" /></div>
//               <div style={{ width: '15%', display: 'flex', alignItems: 'center' }}>
//                 <img src={item.image} alt="watch" style={{ width: 40, height: 40, marginRight: 6, borderRadius: 4, objectFit: 'cover' }} />
...
//                 <button style={{ padding: '4px 8px' }}>-</button>
//               </div>
//               <div style={{ width: '20%', display: 'flex', gap: 8 }}>
//                 <button style={{ padding: '4px 8px' }}>✏️</button>
//                 <button style={{ padding: '4px 8px' }}>👁️</button>
//                 <button style={{ padding: '4px 8px', backgroundColor: 'red', color: 'white', border: 'none', borderRadius: 4 }}>x</button>
//               </div>
//             </div>
//           );
//         })}
